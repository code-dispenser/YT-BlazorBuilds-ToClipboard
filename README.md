...
This repository contains the solution from my YouTube video showing how to build an accessible copy to clipboard component.

YouTube video: https://youtu.be/yqflliTlmdo
